<template>
  ...
  <div class="users">
    ...
    <!-- <el-button class="addBtn" plain type="success"></el-button> -->
    <el-button type="success" class="addBtn" @click="dialogVisible = true">添加用户</el-button>
...
<script>
export default {
  // 需要数据, 表格才能展示, 一进入页面, 应该发送ajax请求, 获取需要的数据
  data () {
    return {
      userList: [],
      query: '',
